# Plot 1 - creating line graph of Global Active Power against datetime
# and output to plot2.png
#
...
plot2 <- function()
{
    ...
    plot(x=plotdata$Time, y=plotdata$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
